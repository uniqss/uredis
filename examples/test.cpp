...
class User {
   public:
    User(int64_t u, int64_t mid) : uid(u), currmsgid(mid) {}
    int64_t uid;
    int64_t currmsgid;
...
#define PR cout << __FUNCTION__ << __LINE__ << " result:" << result << endl;
    ...
    result = r.cmd(u.uid, EUO_setlld, nullptr, nullptr, "SET %s %lld", gsk, u.getset_lld);
    PR;
    result = r.cmd(u.uid, EUO_getlld, test_cb, &u, "GET %s", gsk);
    PR;
    result = r.cmd(u.uid, EUO_setstr, nullptr, nullptr, "SET %s %s", gsks, u.getset_str.c_str());
    PR;
    result = r.cmd(u.uid, EUO_getstr, test_cb, &u, "GET %s", gsks);
    PR;
    result = r.cmd(u.uid, EUO_getlld, test_cb, nullptr, "GET %s", key_ne);
    PR;
    ...
    result = r.cmd(u.uid, EUO_msetlld, nullptr, nullptr, "MSET %s %lld %s %lld %s %lld", mgsk1,
                   u.mgetset_lld1, mgsk2, u.mgetset_lld2, mgsk3, u.mgetset_lld3);
    PR;
    result = r.cmd(u.uid, EUO_mgetlld, test_cb, &u, "MGET %s %s %s", mgsk1, mgsk2, mgsk3);
    PR;
    result = r.cmd(u.uid, EUO_msetstr, nullptr, nullptr, "MSET %s %s %s %s %s %s", mgsk1s,
                   u.mgetset_str1.c_str(), mgsk2s, u.mgetset_str2.c_str(), mgsk3s,
                   u.mgetset_str3.c_str());
    PR;
    result = r.cmd(u.uid, EUO_mgetstr, test_cb, &u, "MGET %s %s %s", mgsk1s, mgsk2s, mgsk3s);
    PR;
    result = r.cmd(u.uid, EUO_mgetstr, test_cb, nullptr, "MGET %s %s %s", field_ne1, field_ne2,
                   field_ne3);
    PR;
    ...
    result =
        r.cmd(u.uid, EUO_hsetlld, nullptr, nullptr, "HSET %s %s %lld", hgsk, hgsf, u.hgetset_lld);
    PR;
    result = r.cmd(u.uid, EUO_hgetlld, test_cb, &u, "HGET %s %s", hgsk, hgsf);
    PR;
    result = r.cmd(u.uid, EUO_hsetstr, nullptr, nullptr, "HSET %s %s %s", hgsks, hgsfs,
                   u.hgetset_str.c_str());
    PR;
    result = r.cmd(u.uid, EUO_hgetstr, test_cb, &u, "HGET %s %s", hgsks, hgsfs);
    PR;
    result = r.cmd(u.uid, EUO_hgetlld, test_cb, nullptr, "HGET %s %s", key_ne, field_ne);
    PR;
    ...
    const char *hmgsf1 = "hmgetset_field1", *hmgsf2 = "hmgetset_field2",
               *hmgsf3 = "hmgetset_field3";
    const char *hmgsf1s = "hmgetset_field1s", *hmgsf2s = "hmgetset_field2s",
               *hmgsf3s = "hmgetset_field3s";
    result = r.cmd(u.uid, EUO_hmsetlld, nullptr, nullptr, "HMSET %s %s %lld %s %lld %s %lld", hmgsk,
                   hmgsf1, u.hmgetset_lld1, hmgsf2, u.hmgetset_lld2, hmgsf3, u.hmgetset_lld3);
    PR;
    result =
        r.cmd(u.uid, EUO_hmgetlld, test_cb, &u, "HMGET %s %s %s %s", hmgsk, hmgsf1, hmgsf2, hmgsf3);
    PR;
    result = r.cmd(u.uid, EUO_hmsetstr, nullptr, nullptr, "HMSET %s %s %s %s %s %s %s", hmgsks,
                   hmgsf1s, u.hmgetset_str1.c_str(), hmgsf2s, u.hmgetset_str2.c_str(), hmgsf3s,
                   u.hmgetset_str3.c_str());
    PR;
    result = r.cmd(u.uid, EUO_hmgetstr, test_cb, &u, "HMGET %s %s %s %s", hmgsks, hmgsf1s, hmgsf2s,
                   hmgsf3s);
    PR;
    result = r.cmd(u.uid, EUO_hmgetstr, test_cb, nullptr, "HMGET %s %s %s %s", key_ne, field_ne1,
                   field_ne2, field_ne3);
    PR;
    ...
    result = r.cmd(u.uid, 0, nullptr, nullptr, "zadd %s %lld %s %lld %s %lld %s", zkey, u.s1,
                   u.r1.c_str(), u.s2, u.r2.c_str(), u.s3, u.r3.c_str());
    PR;
    result = r.cmd(u.uid, EUO_zrange, test_cb, &u, "zrange %s 0 -1", zkey);
    PR;
    result = r.cmd(u.uid, EUO_zrangescore, test_cb, &u, "zrange %s 0 -1 withscores", zkey);
    PR;
